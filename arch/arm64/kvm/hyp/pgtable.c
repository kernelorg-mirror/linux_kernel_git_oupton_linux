				...
				struct stage2_map_data *data)
{
	...
	/*
	 * Clean the D-cache when replacing a writable block with a table.
	 * In cases where KVM lazily remaps the affected IPA range, it is
	 * possible that an intervening unmap walker will fail to clean the
