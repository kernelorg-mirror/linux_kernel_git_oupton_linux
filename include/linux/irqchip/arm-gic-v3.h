...
#define GITS_IIDR_IMPLEMENTER_SHIFT	0
#define GITS_IIDR_IMPLEMENTER_MASK	(0xfff << GITS_IIDR_IMPLEMENTER_SHIFT)
...
#define GITS_IIDR_PRODUCTID_MASK	(0xff << GITS_IIDR_PRODUCTID_SHIFT)
